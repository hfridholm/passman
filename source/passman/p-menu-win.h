...
extern void   menu_win_focus_set(menu_t* menu, char* win_name);


extern win_t*         menu_win_get(menu_t* menu, char* win_name);

extern win_list_t*    menu_win_list_get(menu_t* menu, char* win_name);

extern win_confirm_t* menu_win_confirm_get(menu_t* menu, char* win_name);

extern win_text_t*    menu_win_text_get(menu_t* menu, char* win_name);

extern win_input_t*   menu_win_input_get(menu_t* menu, char* win_name);
...
extern void menu_win_input_buffer_set(menu_t* menu, char* win_name, char* buffer, size_t size);

extern void menu_win_input_buffer_clear(menu_t* menu, char* win_name);
...
extern bool menu_win_confirm_answer_get(menu_t* menu, char* win_name);
